            ...
            <div className="md:hidden border-t border-blue-900 bg-blue-950 px-6 py-6 flex flex-col gap-4 shadow-2xl">
              ...
              <div>
                <button 
                  ...
                  className="w-full flex items-center justify-between text-lg font-medium hover:text-blue-300 transition py-2 border-b border-blue-900/50"
                >
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-14 items-center">
          <div>
            ...
            <div className="mt-10 flex gap-4 flex-wrap">
              ...
              <div className="bg-white shadow-xl rounded-2xl p-6">
                <h3 className="text-4xl font-black text-red-600">+8000</h3>
                <p>Âmes restaurées</p>
              </div>
            </div>
          </div>
