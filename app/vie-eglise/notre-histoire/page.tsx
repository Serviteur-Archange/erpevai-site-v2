...
export default function NotreHistoire() {
  ...
  backgroundPosition: "center 10%" // Ajuste le pourcentage pour descendre ou monter l'image (essaie 20%, 30%, 40%...)
}}
      >
        ...
        {/* NAVBAR EN RECTANGLE */}
        <header className="relative z-20 w-full h-20 bg-red-950/90 backdrop-blur-md border-b border-blue-900 flex items-center justify-between px-6 md:px-12 text-white shadow-lg">
  ...
  <div className="bg-blue-950/80 backdrop-blur-md border border-blue-500/30 px-8 py-4 rounded-xl max-w-2xl shadow-lg">
    <p className="text-xl md:text-2xl text-blue-100 leading-relaxed">
      ...
      <section className="py-24 px-6 md:px-20">
        ...
        <div className="max-w-5xl mx-auto flex flex-col gap-16 md:gap-24"> {/* Espacement plus grand entre les rubriques pour aérer la lecture */}
...
{/* === RUBRIQUE 5 (VISION APOSTOLIQUE INTERNATIONALE) === */}
        <div className="w-full min-h-[60vh] flex flex-col md:flex-row items-stretch py-12 bg-slate-50 text-slate-800">
          ...
          <div className="w-full md:w-1/2 flex flex-col items-center justify-center p-6 space-y-8">
            ...
            {/* Première photo (L'Apôtre Ouli Samuel) */}
            ...
            {/* Deuxième photo (L'Apôtre Kpangui Bernard) */}
            <div className="bg-white p-3 rounded-2xl shadow-xl w-full max-w-[400px]">
              <div className="relative aspect-[4/3] w-full">
                <Image
          ...
          <div className="w-full md:w-1/2 flex items-center justify-center px-4 md:px-8 py-8">
            <div className="bg-amber-50/80 border border-amber-200/60 p-8 md:p-12 rounded-3xl shadow-xl space-y-6 text-left w-full max-w-[550px]">
              ...
              <p className="text-base md:text-lg leading-relaxed text-amber-900/90">
                La Vision Apostolique Internationale est un mouvement chrétien mondial et un réseau d'églises unies pour propager le Plein Évangile. Convaincus qu'une croissance durable repose sur une excellente santé spirituelle, nous cultivons des standards élevés d'engagement et d'intégrité pour nos membres et nos dirigeants, afin d'impacter efficacement notre génération.
              </p>
