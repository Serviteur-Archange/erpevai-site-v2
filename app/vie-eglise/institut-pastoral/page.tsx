...
export default function institutpastoralpage() {
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      {/* 1. HEADER GLOBAL */}
      <header className="relative z-40 w-full h-20 bg-green-600/95 backdrop-blur-md border-b">
        <div className="relative flex items-center h-full px-4 md:px-8 justify-between max-w-7xl mx-auto">
          ...
          <div className="flex items-center gap-8">
            <nav className="hidden md:flex items-center gap-8 text-lg font-medium text-white relative">
              <Link href="/" className="hover:text-green-200 transition-colors">Accueil</Link>
              ...
              >
                <button className="hover:text-green-200 transition-colors flex items-center gap-1 focus:outline-none">
                  Vie de l'Église
